...
import { MediaTypeEnum, MediaPostType } from "@/types/mediaPost";
      ...
      case 1:
        return (
          <div className="relative flex">
            {mediaArr[0].media_type_id === MediaTypeEnum.IMAGE
          ...
          <div className="flex gap-x-1">
            {mediaArr.map((media, index) => (
              <div key={index} className="h-full w-full">
                {media.media_type_id === MediaTypeEnum.IMAGE
        ...
        return (
          <div className="flex h-[500px] flex-col gap-y-[2px]">
            ...
            <div className="flex gap-x-[2px]">
              {mediaArr[1].media_type_id === MediaTypeEnum.IMAGE
                ? renderImage(mediaArr[1].media_url, "h-[249px]")
                : renderVideo(mediaArr[1].media_url, "h-[249px]")}
              {mediaArr[2].media_type_id === MediaTypeEnum.IMAGE
        ...
        return (
          <div className="flex flex-col gap-y-[2px]">
            ...
            <div className="grid grid-cols-3 gap-x-[2px]">
              ...
              {mediaArr[3].media_type_id === MediaTypeEnum.IMAGE
                ? renderImage(mediaArr[3].media_url, "h-[199.2px]")
                : renderVideo(mediaArr[3].media_url, "h-[199.2px]")}
              {mediaArr[4].media_type_id === MediaTypeEnum.IMAGE
...
export default memo(MediaPostGrid);
